...
Session ::Session(const Session &aSession):cycle(aSession.cycle),g(aSession.g),treeType(aSession.treeType),agents()
{
...
Session::Session(const Session &&aSession) : cycle(aSession.cycle),g(aSession.g),treeType(aSession.treeType),agents(std::move(aSession.agents)){
...
void Session::setGraph(const std::vector<std::vector<int>> Graph)
{
    g.SetGraph(Graph);
}
