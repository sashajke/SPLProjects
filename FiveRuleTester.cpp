...
////    delete(test1);
////    if(test3.GetChildren()[0]->GetRoot() == 3){
...
////    if(testAssignment.GetChildren()[0]->GetRoot()  == 3)
...
////    if(testMove2.GetChildren()[0]->GetRoot() == 5 && testMove1.GetChildren().size() == 0)
...
////    if(testMove2.GetChildren()[0]->GetRoot() == 5 )
